...
class Assistant {
  ...
  static void setUpDefaults() {
    ...
    PreferenceKeys.setPreference<String>(PreferenceKeys.messageVibrate, "Default");
    PreferenceKeys.setPreference<String>(PreferenceKeys.messagePopup, "No popup");
    PreferenceKeys.setPreference<String>(PreferenceKeys.messageSound, "No popup");
    PreferenceKeys.setPreference<String>(PreferenceKeys.messagePriority, "Default");
    ...
    PreferenceKeys.setPreference<String>(PreferenceKeys.groupVibrate, "Default");
    ...
    PreferenceKeys.setPreference<String>(PreferenceKeys.groupPriority, "Default");
    ...
    PreferenceKeys.setPreference<String>(PreferenceKeys.whoViewLastSeen, "My Contacts");
    PreferenceKeys.setPreference<String>(PreferenceKeys.whoCanCallMe, "My Contacts");

    PreferenceKeys.setPreference<String>(PreferenceKeys.onMobileData, "No Media");
    PreferenceKeys.setPreference<String>(PreferenceKeys.onWifi, "No Media");

    PreferenceKeys.setPreference<String>(PreferenceKeys.chatBackground, "assets/chatBackground_8.jpeg");

    PreferenceKeys.setPreference<String>(PreferenceKeys.selectedTheme, "DefaultLight");

    PreferenceKeys.setPreference<String>(PreferenceKeys.selectedTheme, "English");
